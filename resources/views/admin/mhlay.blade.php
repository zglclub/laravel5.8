            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('admin.article.list')}}">文章列表</a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('admin.manager.list')}}">管理员列表</a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic1">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route("admin.config.siteconfig")}}">系统配置</a></li>
