...
<head>
    ...
    <title><?php echo $__env->yieldContent("siteTitle"); ?></title>
    <!-- plugins:css -->
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                                <h6 class="preview-subject ellipsis mb-1 font-weight-normal">message</h6>
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                                <h6 class="preview-subject ellipsis mb-1 font-weight-normal">a message</h6>
                                <p class="text-gray mb-0">
                                    15分钟
                                </p>
                            </div>
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                                <h6 class="preview-subject ellipsis mb-1 font-weight-normal">隔热板</h6>
                                <p class="text-gray mb-0">
                                    18 Minutes ago
                                </p>
                            </div>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.index.index')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('admin.article.list')); ?>">文章列表</a></li>
                            <li class="nav-item"> <a class="nav-link" href="">文章添加</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('admin.manager.list')); ?>">管理员列表</a></li>
                            <li class="nav-item"> <a class="nav-link" href="">权限添加</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic1">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(route("admin.config.siteconfig")); ?>">系统配置</a></li>
                            <li class="nav-item"> <a class="nav-link" href="../pages/ui-features/typography.html">网站设计</a></li>
                        </ul>
                    </div>
                </li>
            ...
            <span class="nav-link">
              ...
              <button class="btn btn-block btn-lg btn-gradient-primary mt-4">+ 添加</button>
              <div class="mt-4">
                <div class="border-bottom">
                ...
                <ul class="gradient-bullet-list mt-4">
                  <li>QQ: 76101700</li>
                  <li>Email:zlhackli@gmail.com</li>
                    <li>version :1.0.0</li>
                </ul>
              </div>
            </span>
...
<?php /**PATH H:\phptools\PHPTutorial\WWW\laravel\resources\views/admin/mhlay.blade.php ENDPATH**/ ?>