          ...
          <div class="card-body">
            ...
            <div class="row mt-3">
              <div class="col-6 pr-1">
                <img src="/static/admin/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                <img src="/static/admin/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
              </div>
              <div class="col-6 pl-1">
                <img src="/static/admin/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                <img src="/static/admin/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
              </div>
            </div>
            <div class="d-flex mt-5 align-items-top">
              <img src="/static/admin/images/faces/face3.jpg" class="img-sm rounded-circle mr-3" alt="image">
...
<?php echo $__env->make('admin.mhlay', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\phptools\PHPTutorial\WWW\laravel\resources\views/admin/index/index.blade.php ENDPATH**/ ?>